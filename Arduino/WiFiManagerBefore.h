...
const String WiFiManager_VariableNames[] = {"SSID", "Password", "name", "PollingRateSec",
                                            "Domoticz IP", "Dom port",
                                            "I2C address0 DEC!", "Dom IDX0 (Temp+hum)",
                                            "I2C address1 DEC!", "Dom IDX1 (Temp+hum)"
                                           };
...
char Name[16] = "SHT";                                          //If you want to define the name somewhere else use 'char* Name = Name'
